...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.up6_1 = nn.Conv2d(in_channels=128, out_channels=64, kernel_size=3, padding='same')
        self.act6 = nn.ReLU()
